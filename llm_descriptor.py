...
class LLMDescriptor:
    ...
    def generate_description(self, 
        ...
        """
        prompt = f"""Based on the following object detections from a street scene, provide a clear, concise description that would help a blind person navigate safely.

{detection_summary}

Please describe:
1. What objects are present and their relevance for navigation
2. Any safety concerns (e.g., vehicles, traffic signals)
3. Navigation aids (e.g., crosswalks, tactile paths)
4. Keep it brief and actionable (2-3 sentences max)
